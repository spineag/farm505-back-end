...
//
//
//$result = $mainDb->query("SELECT social_id FROM users ORDER BY RAND() LIMIT 100");
//$ar = $result->fetchAll();
//
//
//if ($ar) {
...
//                $sendNotif = $fb->post('/' . $value . '/notifications', array('href' => '?notif', 'template' => 'Today is a good day!'), $app_token);
//            }
//        } catch (Exception $e) {
//            echo $e;
//        }
